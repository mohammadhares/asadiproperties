...
<!-- Mirrored from creativelayers.net/themes/homez-html/page-dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 Oct 2023 11:54:40 GMT -->
<head>
<meta charset="utf-8">
                  ...
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                      <div class="user_setting_content">
                        ...
                        <a class="dropdown-item active" href="page-dashboard.html"><i class="flaticon-discovery mr10"></i>Dashboard</a>
  ...
  <div id="page" class="mobilie_header_nav stylehome1">
      ...
      <div class="header innerpage-style">
        <div class="menu_and_widgets">
          <div class="mobile_menu_bar d-flex justify-content-between align-items-center">
            ...
            <a class="mobile_logo" href="#"><img src="images/logo.1." alt=""></a>
    ...
    <nav id="menu" class="">
       <ul>
        ...
        <li> <a href="rent.html">Properites</a>
        </li>
        <li> <a href="sale.html">Project</a>
        </li>
        <li> <a href="off plane.html">Blog</a>
        </li>
        <li> <a href="about.html">Subscribe</a>
        </li>
        <li> <a href="blog.html">Setting</a>
        </li>
        <li> <a href="page-contact.html">User</a>
        </li>
        <li> <a href="page-contact.html">Profile</a>
        </li>
        <li> <a href="page-contact.html">Logout</a>
        </li>
      ...
      <div class="dashboard__sidebar d-none d-lg-block">
        <div class="dashboard_sidebar_list">
          ...
          <div class="sidebar_list_item ">
            <a href="home.html" class="items-center"><i class="flaticon-home mr15"></i>Home</a>
          </div>
          <div class="sidebar_list_item ">
            ...
            <div class="col-xxl-9">
              <div class="dashboard_search_meta d-md-flex align-items-center justify-content-xxl-end">
                <div class="item1 mb15-sm">
                  ...
                  <button type="button"  data-bs-toggle="modal" data-bs-target="#myModal" class="ud-btn btn-thm"><i class="fal fa-arrow-right-long"></i>
                   Add New Property
                  </button>
                      <!-- The Modal -->
                      <div class="modal" id="myModal">
                        ...
                        <form class="form-style1">
                          <div class="row">
                            ...
                            <div class="col-sm-6 col-xl-4">
                              <div class="mb20">
                                <label class="heading-color ff-heading fw600 mb10">content</label>
                                <input type="text" class="form-control" placeholder="Your Name">
                              </div>
                            </div>
                            <div class="col-sm-6 col-xl-4">
                            ...
                            <div class="col-sm-6 col-xl-4">
                              <div class="mb20">
                                <label class="heading-color ff-heading fw600 mb10">size</label>
                                <input type="text" class="form-control" placeholder="Your Name">
                              </div>
                            </div>
                            <div class="col-sm-6 col-xl-4">
                            ...
                            <div class="col-sm-6 col-xl-4">
                              <div class="mb20">
                                <label class="heading-color ff-heading fw600 mb10">year_built</label>
                            ...
                            <div class="col-sm-6 col-xl-4">
                              <div class="mb20">
                                <label class="heading-color ff-heading fw600 mb10">features</label>
                                <input type="text" class="form-control" placeholder="Your Name">
                              </div>
                            </div>
                            <div class="col-sm-6 col-xl-4">
                              <div class="mb20">
                                <label class="heading-color ff-heading fw600 mb10">property_type</label>
                                <input type="text" class="form-control" placeholder="Your Name">
                              </div>
                            </div>
                            <div class="col-sm-6 col-xl-4">
                            ...
                            <div class="col-sm-6 col-xl-4">
                              <div class="mb20">
                                <label class="heading-color ff-heading fw600 mb10">modified_by</label>
                  ...
                  <table class="table-style3 table at-savesearch">
                    ...
                    <tbody class="t-body">
                      <tr>
                        ...
                        <td class="vam">
                          <div class="d-flex">
                            <a href="add-pro-propartis.html" class="icon" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><span class="fas fa-pen fa"></span></a>
                            ...
                            <div class="item1 mb15-sm">
                              <div class="container mt-3">
                                ...
                                <button type="button"  class="ud-btn btn-thm" data-bs-toggle="modal" data-bs-target="#myModall">
                                  view
                                </button>
                              </div>
...
<!-- Mirrored from creativelayers.net/themes/homez-html/page-dashboard-properties.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 Oct 2023 11:54:44 GMT -->
</html>
