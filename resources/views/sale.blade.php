...
@section('content')
    ...
    <div class="body_content_wrapper">
        <section class="home-banner-style1 p0" style="background-image: url({{ asset('assets/images/home/home-10.jpg') }}) !important; background-size: cover !important;">
            <div class="home-style1 h-500">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-11 mx-auto">
                            <div class="inner-banner-style1 text-center">
                                <h2 class="hero-title animate-up-2">Buy Your Dream Home</h2>
                                <p class="hero-text fz15 animate-up-3">We’ve more than 745,000 apartments, place & plot.</p>
                                @include('component.BasicFilters', ['property_status' => 'SALE'])
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="breadcumb-style1">
                                <h2 class="title">{{ $result->total() }} Property for sale</h2>
                                <div class="breadcumb-list">
                                    <a href="/">Home</a>
                                    <a href="/rent">For Sale</a>
                                </div>
                            </div>
                        </div>
                    </div>
