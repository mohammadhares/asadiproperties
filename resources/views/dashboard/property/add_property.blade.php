                            ...
                            <form
                                ...
                                <div class="col-sm-12">
                                  <div class="mb20">
                                    ...
                                    <input value="@if($mode === 'EDIT') {{ $item->title }} @endif" type="text" name="title" required class="form-control" placeholder="Ex. hotel, apartement, house...">
                                  </div>
                                </div>
                                <div class="col-sm-12">
                                  <div class="mb20">
                                    <label class="heading-color ff-heading fw600 mb10">Description</label>
                                    <textarea cols="30" rows="5" name="content" placeholder="There are many variations of passages.">
                                ...
                                <div class="col-sm-6 col-xl-4">
                                  <div class="mb20">
                                    ...
                                    <input type="text" required value="@if($mode === 'EDIT') {{ $item->property_type }} @endif" name="property_type" class="form-control" placeholder="Ex: Home">
                                  </div>
                                </div>
                                <div class="col-sm-6 col-xl-4">
                                  <div class="mb20">
                                    ...
                                    <div class="location-area">
                                      <select name="status" class="selectpicker">
                                        <option @if($mode === 'EDIT') @if($item->status === 'Rent') {{ 'selected' }} @endif @endif>Rent</option>
                                        <option @if($mode === 'EDIT') @if($item->status === 'Sale') {{ 'selected' }} @endif @endif>Sale</option>
                                      </select>
                                    </div>
                                  </div>
                                </div>
                                <div class="col-sm-6 col-xl-4">
                                  <div class="mb30">
                                    <label class="heading-color ff-heading fw600 mb10">Price in AED </label>
                                    <input type="number" @if($mode === 'EDIT') value="{{ $item->price }}" @endif  name="price" class="form-control" placeholder="Ex: 1200">
                                  </div>
                                </div>
                                <div class="col-sm-6 col-xl-4">
                                  <div class="mb30">
                                    <label class="heading-color ff-heading fw600 mb10">Size in ft/m</label>
                                    <input type="number" @if($mode === 'EDIT') value="{{ $item->size }}" @endif   name="size" class="form-control" placeholder="Ex: 200">
                                  </div>
                                </div>
                                <div class="col-sm-6 col-xl-4">
                                  <div class="mb30">
                                    <label class="heading-color ff-heading fw600 mb10">Bedrooms</label>
                                    <input type="number" required @if($mode === 'EDIT') value="{{ $item->bedrooms }}" @endif   name="bedrooms" class="form-control" placeholder="Ex: 5">
                                  </div>
                                </div>
                                <div class="col-sm-6 col-xl-4">
                                    <div class="mb30">
                                      <label class="heading-color ff-heading fw600 mb10">Bathrooms</label>
                                      <input type="number" required @if($mode === 'EDIT') value="{{ $item->bathrooms }}" @endif   name="bathrooms" class="form-control" placeholder="Ex: 4">
                                    </div>
                                  </div>
                                  <div class="col-sm-6 col-xl-4">
                                    <div class="mb30">
                                      <label class="heading-color ff-heading fw600 mb10">Build Year</label>
                                      <input type="date"  required @if($mode === 'EDIT') value="{{ $item->year_built }}" @endif  name="build_year" class="form-control" placeholder="">
                                    </div>
                                  </div>
                                  <div class="col-sm-6 col-xl-4">
                                    <div class="mb30">
                                      <label class="heading-color ff-heading fw600 mb10">Thumbnail</label>
                                      <input type="file" @if($mode === 'ADD') required @endif name="thumbnail" class="form-control" placeholder="">
                                    </div>
                                  </div>
                                  @if($mode === 'EDIT')
                                  <div class="col-sm-6 col-lg-4" >
                                    <div class="profile-box position-relative d-md-flex align-items-end mb50" style="top: 25px">
                                      <div class="profile-img position-relative overflow-hidden bdrs12 mb20-sm">
                                        <img style="width: 200px !important;" class="w-100" src="{{ asset($item->thumbnail) }}" alt="">
                                      </div>
                                    </div>
                                  </div>
                                  @endif
                                  <div class="col-md-12">
                                    <div class="d-sm-flex text-right" style="!important; justify-content: right;">
                                      <a class="ud-btn btn-white" href="{{ route('property.view') }}">Back</a>
                          ...
                          <div class="ps-widget bgc-white bdrs12 p30 overflow-hidden position-relative">
                            ...
                            <div class="col-lg-12">
                              <div class="upload-img position-relative overflow-hidden bdrs12 text-center mb30 px-2">
                                ...
                                <p class="text mb25">Photos must be JPEG or PNG format and least 500x500</p>
                                <form
                                    id="imageUploadForm"
                                    enctype="multipart/form-data">
                            ...
                            <div class="col-lg-12">
                              <div class="profile-box position-relative d-md-flex align-items-end mb50" id="data-container">
                              </div>
                            </div>
                          </div>
                        </div>
                              ...
                              <div class="row">
                                <div class="col-sm-12">
                                  <div class="mb20">
                                    ...
                                    <input type="text" required @if($mode === 'EDIT') value="{{ $item->address }}" @endif  name="address" id="address" class="form-control" placeholder="Full address">
                                  </div>
                                </div>
                                <div class="col-sm-6 col-xl-4">
                                  <div class="mb20">
                                    <label class="heading-color ff-heading fw600 mb10">Country / State</label>
                                    <input type="text" required name="country" @if($mode === 'EDIT') value="{{ $item->country }}" @endif  id="country" class="form-control" placeholder="Ex: USA, UK, UAE...">
                                  </div>
                                </div>
                                <div class="col-sm-6 col-xl-4">
                                  <div class="mb20">
                                    <label class="heading-color ff-heading fw600 mb10">City</label>
                                    <input type="text" required name="city" @if($mode === 'EDIT') value="{{ $item->city }}" @endif  id="city" class="form-control" placeholder="Ex: Paris, Kabul...">
                                  </div>
                                </div>
                                <div class="col-sm-12">
                                  <div class="mb20 mt30">
                              ...
                              <div class="row">
                                <div class="col-sm-6 col-xl-4">
                                  <div class="mb30">
                                    ...
                                    <input id="latitude" type="number" @if($mode === 'EDIT') value="{{ $item->latitude }}" @endif  class="form-control" placeholder="">
                                  </div>
                                </div>
                                <div class="col-sm-6 col-xl-4">
                                  <div class="mb30">
                                    <label class="heading-color ff-heading fw600 mb10">Longitude</label>
                                    <input id="longitude" type="number" @if($mode === 'EDIT') value="{{ $item->longitude }}" @endif  class="form-control" placeholder="">
                                  </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="d-sm-flex text-right" style="!important; justify-content: right;">
